  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        console.log("User signed up", response.data.savedUser);
        // setEmail(" ");
        // setName(" ");
        // setPassword(" ")
            ...
            <div className="mt-5">
              ...
              <form>
                <div className="grid gap-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        id="email"
                        name="email"
                        className="py-3 px-4 block w-full border-black border outline-none rounded-lg text-sm "
                        required=""
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        id="password"
                        name="password"
                        className="py-3 px-4 block w-full border border-black rounded-lg text-sm outline-none"
                        required=""
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="py-3 px-4 block w-full border-black border rounded-lg text-sm outline-none"
                        required=""
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-black bg-black text-white  "
                  >
                    Sign up
                  </button>
                </div>
